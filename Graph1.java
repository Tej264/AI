...
class Graph1 {
    ...
    public void greedySearch(int src) {
        ...
        for (int i = 0; i < numVertices; i++) {
            ...
            for (Edge adjEdge : adjLists.get(minDistanceVertex)) {
                if (!visited[adjEdge.dest] && distances[minDistanceVertex] + adjEdge.weight <distances[adjEdge.dest]) {
                    distances[adjEdge.dest] = distances[minDistanceVertex] + adjEdge.weight;
                }
            }
        }
    ...
    static class Edge implements Comparable<Edge> {
        ...
        public String toString() {
            return "Edge to " + dest + " with weight " + weight;
        }
